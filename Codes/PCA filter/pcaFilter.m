...
% Version: v 1.0
%
% This function performs PCA filtering on the input matrix. It denoises 
% the data by taking the SVD of a matrix, keeping the top 
% `numComponents` singular vectors/values, and reconstructing the matrix 
% from these components. It returns the reconstructed (filtered) matrix.
%
% INPUTS:
...
%
% Use example: [filteredMatrix] = pcaFilter(inputMatrix, 5);
%
% Disclaimer:
